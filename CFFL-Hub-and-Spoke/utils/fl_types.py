...
class ClientTrainResult(TypedDict):
    ...
    client_training_time: NotRequired[float]
    client_training_bcast_block_time: NotRequired[float]
    normalized_model_update: NotRequired[npt.NDArray[np.generic]]
    flattened_normalized_gradient: NotRequired[npt.NDArray[np.generic]]
