...
def load_data(
    ...
    """Load one CIFAR10 client partition with InnerDirichlet on train split and a centralized validation split.
    ...
    def apply_transforms(batch):
        batch["img"] = [pytorch_transforms(x) for x in batch["img"]]
        return batch
...
def _get_fds(
    ...
    valid_n = int(CIFAR10_TRAIN_SIZE * validation_fraction)
    train_n = CIFAR10_TRAIN_SIZE - valid_n
