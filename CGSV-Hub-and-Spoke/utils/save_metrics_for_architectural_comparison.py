...
SERVER_HEADERS = [
    ...
    "memory_footprint_server_round_start",
    "memory_footprint_server_collecting_train_results",
    "memory_footprint_server_normalizing_gradients",
    "memory_footprint_server_aggregating_gradients",
    "memory_footprint_server_updating_global_model",
    "memory_footprint_server_computing_cosine_similarities",
    "memory_footprint_server_computing_sparsified_gradients",
    "memory_footprint_server_constructing_rewards_payload",
    "memory_footprint_server_scattering_rewards_payload",
    "memory_footprint_server_collecting_testing_results",
    "round_peak_memory_footprint",
    "global_peak_memory_footprint",
]
...
def write_server_metrics(
    ...
    memory_footprint_server_round_start: float,
    memory_footprint_server_collecting_train_results: float,
    memory_footprint_server_normalizing_gradients: float,
    memory_footprint_server_aggregating_gradients: float,
    memory_footprint_server_updating_global_model: float,
    memory_footprint_server_computing_cosine_similarities: float,
    memory_footprint_server_computing_sparsified_gradients: float,
    memory_footprint_server_constructing_rewards_payload: float,
    memory_footprint_server_scattering_rewards_payload: float,
    memory_footprint_server_collecting_testing_results: float,
    round_peak_memory_footprint: float,
    global_peak_memory_footprint: float, 
) -> None:
