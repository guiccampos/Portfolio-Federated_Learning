...
SVHN_TRAIN_SIZE = 73_257
SVHN_TEST_SIZE = 26_032
...
def load_data(
    ...
    """Load one SVHN client partition with InnerDirichlet on train split and a centralized validation split.
...
def _get_fds(
    ...
    valid_n = int(SVHN_TRAIN_SIZE * validation_fraction)
    train_n = SVHN_TRAIN_SIZE - valid_n
