...
from torchvision.models import shufflenet_v2_x0_5, shufflenet_v2_x1_0, shufflenet_v2_x1_5, shufflenet_v2_x2_0, ShuffleNetV2
...
# Preparing ShuffleNetV2
def PrepareShuffleNetV2(version: str = "shufflenet_v2_x1_0") -> ShuffleNetV2:
    builders = {
    ...
    # Keep the original BN + ReLU structure, only adapt the first conv for CIFAR
    ...
    # Remove ImageNet-style downsampling
    model.maxpool = nn.Identity()

    # Adapt classifier to CIFAR100
