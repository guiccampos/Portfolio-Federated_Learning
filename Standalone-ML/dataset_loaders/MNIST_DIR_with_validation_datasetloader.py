...
def load_data(
    ...
    """Load one MNIST client partition with InnerDirichlet on train split and a centralized validation split.
...
def _get_fds(
    ...
    valid_n = int(MNIST_TRAIN_SIZE * validation_fraction)
    train_n = MNIST_TRAIN_SIZE - valid_n
